# streamlit_app.py
# Telemark · Pro Wax & Tune — orchestratore minimale e ordinato
...
# iso2 lo lasciamo vuoto: i moduli che non lo usano semplicemente lo ignorano
ctx = {
    "lat": float(lat),
    "lon": float(lon),
...
MODULES = [
    ("core.site_meta", ["render_site_meta", "render"]),  # altitudine / TZ / DEM base
...
for modname, candidates in MODULES:
    ...
    # niente banner aggiuntivo: gli errori vengono già mostrati in rosso
